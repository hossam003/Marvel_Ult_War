...
//			targets.add(getCurrentChampion());
	...
	public void endTurn() {
		Champion current = (Champion) turnOrder.peekMin();// moved up
		updateTimers((Champion) turnOrder.peekMin());// moved up
		...
		if (turnOrder.isEmpty())// added
			prepareChampionTurns();// added
	}
